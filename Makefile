...
gen_protos_go:
	...
	protoc -I=./proto --go_opt=paths=source_relative --go_out=plugins=grpc:./gen/Go/ ./proto/payments/*.proto
...
gen_protos_py:
	...
	python3 -m grpc_tools.protoc -I proto --python_out=gen/Python --mypy_out=gen/Python --grpc_python_out=gen/Python proto/payments/*.proto
