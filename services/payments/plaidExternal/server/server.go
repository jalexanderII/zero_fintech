...
func (p PaymentsServer) GetTransactions(ctx context.Context, in *payments.GetTransactionsRequest) (*payments.GetTransactionsResponse, error) {
	...
	URL := "http://127.0.0.1:8000/api/transactions/internal"
	resp, err := http.Post(URL, "application/json", bytes.NewBuffer(jsonData))
	if err != nil {
		log.Fatal(err)
	}
	...
	return &payments.GetTransactionsResponse{TransactionsGetResponse: b}, nil
}
