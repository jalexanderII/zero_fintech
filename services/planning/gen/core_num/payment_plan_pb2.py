...
_PAYMENTACTIONSTATUS = _descriptor.EnumDescriptor(
  ...
  full_name='core.PaymentActionStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_PAYMENTACTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='account_id', full_name='core.PaymentAction.account_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='amount', full_name='core.PaymentAction.amount', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='transaction_date', full_name='core.PaymentAction.transaction_date', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='core.PaymentAction.status', index=3,
...
_PAYMENTPLAN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='payment_plan_id', full_name='core.PaymentPlan.payment_plan_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payment_action', full_name='core.PaymentPlan.payment_action', index=10,
...
PaymentAction = _reflection.GeneratedProtocolMessageType('PaymentAction', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:core.PaymentAction)
  })
