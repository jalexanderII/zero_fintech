...
@dataclass
class GetDebitAccountBalanceRequest(betterproto.Message):
    user_id: str = betterproto.string_field(1)


@dataclass
class GetDebitAccountBalanceResponse(betterproto.Message):
    available_balance: float = betterproto.double_field(1)
    current_balance: float = betterproto.double_field(2)
...
@dataclass
class NotifyUsersUpcomingPaymentActionsRequest(betterproto.Message):
    pass


@dataclass
class NotifyUsersUpcomingPaymentActionsResponse(betterproto.Message):
    pass
...
class CoreStub(betterproto.ServiceStub):
    ...
    async def notify_users_upcoming_payment_actions(
        self,
    ) -> NotifyUsersUpcomingPaymentActionsResponse:
        """Notify Users about upcoming payment actions"""

        request = NotifyUsersUpcomingPaymentActionsRequest()
    ...
    async def get_debit_account_balance(
        self, *, user_id: str = ""
    ) -> GetDebitAccountBalanceResponse:
        request = GetDebitAccountBalanceRequest()
        request.user_id = user_id
