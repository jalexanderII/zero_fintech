...
#         meta_data: Optional[MetaData], gt_amount_threshold: bool
#     ) -> List[MetaData]:
#         """Creates options for what kind of plans to create given type, timeline, frequency and total amount."""
#         unknown_timeline: List[float] = (
#             [3.0, 6.0, 12.0] if gt_amount_threshold else [1.0]
#         )
#         payment_freq_to_timeline_options: Dict[PaymentFrequency, List[float]] = {
#             PAYMENT_FREQUENCY_UNKNOWN: unknown_timeline,
...
#             freq_options = [payment_freq] if payment_freq != PAYMENT_FREQUENCY_UNKNOWN else payment_freq
#
