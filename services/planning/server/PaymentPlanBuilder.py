...
from Python.core.payment_task_pb2 import PaymentTask
from Python.planning.payment_plan_pb2 import PaymentPlan

def createPaymentPlan(paymentTasks: List[PaymentTask]) -> List[PaymentPlan]:
    """ Creates a PaymentPlan protobuf from given list of PaymentTasks protos.

    Args:
        paymentTasks (List[PaymentTask]): List of PaymentTasks

    Returns:
        List[PaymentPlan]: List of possible PaymentPlans
    """
    pass
