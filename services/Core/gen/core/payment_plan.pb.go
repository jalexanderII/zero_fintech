...
const (
	...
	PaymentStatus_CURRENT PaymentStatus = 1
	...
	PaymentStatus_IN_DEFAULT PaymentStatus = 4
)
...
type PaymentPlan struct {
	...
	PaymentTaskId    []int32          `protobuf:"varint,3,rep,packed,name=payment_task_id,json=paymentTaskId,proto3" json:"payment_task_id,omitempty"`
...
func (x *PaymentPlan) GetPaymentId() int32 {
	if x != nil {
		return x.PaymentId
	}
	return 0
...
func (x *PaymentPlan) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PaymentPlan) GetPaymentTaskId() []int32 {
	if x != nil {
...
var file_payment_plan_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70,
	...
	0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x03, 0x28, 0x05, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x6d,
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x66, 0x0a, 0x0d, 0x50, 0x61, 0x79, 0x6d, 0x65,
	...
	0x57, 0x4e, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x43, 0x55, 0x52, 0x52, 0x45, 0x4e, 0x54, 0x10,
	...
	0x0e, 0x0a, 0x0a, 0x49, 0x4e, 0x5f, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x10, 0x04, 0x42,
