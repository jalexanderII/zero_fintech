...
var file_core_core_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x93, 0x0d, 0x0a, 0x04,
...
var file_core_core_proto_goTypes = []interface{}{
	...
	(*CreateAccountRequest)(nil),                         // 8: core.CreateAccountRequest
	(*GetAccountRequest)(nil),                            // 9: core.GetAccountRequest
	(*ListAccountRequest)(nil),                           // 10: core.ListAccountRequest
	(*ListUserAccountsRequest)(nil),                      // 11: core.ListUserAccountsRequest
	(*CreateTransactionRequest)(nil),                     // 12: core.CreateTransactionRequest
	(*GetTransactionRequest)(nil),                        // 13: core.GetTransactionRequest
	(*ListTransactionRequest)(nil),                       // 14: core.ListTransactionRequest
	(*ListUserTransactionsRequest)(nil),                  // 15: core.ListUserTransactionsRequest
	(*common.CreatePaymentTaskRequest)(nil),              // 16: common.CreatePaymentTaskRequest
	(*common.CreateManyPaymentTaskRequest)(nil),          // 17: common.CreateManyPaymentTaskRequest
	(*common.GetPaymentTaskRequest)(nil),                 // 18: common.GetPaymentTaskRequest
	(*common.ListPaymentTaskRequest)(nil),                // 19: common.ListPaymentTaskRequest
	(*common.UpdatePaymentTaskRequest)(nil),              // 20: common.UpdatePaymentTaskRequest
	(*common.DeletePaymentTaskRequest)(nil),              // 21: common.DeletePaymentTaskRequest
	(*GetUserRequest)(nil),                               // 22: core.GetUserRequest
	(*ListUserRequest)(nil),                              // 23: core.ListUserRequest
	(*UpdateUserRequest)(nil),                            // 24: core.UpdateUserRequest
	(*DeleteUserRequest)(nil),                            // 25: core.DeleteUserRequest
	(*common.PaymentPlanResponse)(nil),                   // 26: common.PaymentPlanResponse
	(*planning.WaterfallOverviewResponse)(nil),           // 27: planning.WaterfallOverviewResponse
	(*planning.GetAmountPaidPercentageResponse)(nil),     // 28: planning.GetAmountPaidPercentageResponse
	(*planning.GetPercentageCoveredByPlansResponse)(nil), // 29: planning.GetPercentageCoveredByPlansResponse
	(*ListAccountResponse)(nil),                          // 30: core.ListAccountResponse
	(*ListTransactionResponse)(nil),                      // 31: core.ListTransactionResponse
	(*common.PaymentTask)(nil),                           // 32: common.PaymentTask
	(*common.CreateManyPaymentTaskResponse)(nil),         // 33: common.CreateManyPaymentTaskResponse
	(*common.ListPaymentTaskResponse)(nil),               // 34: common.ListPaymentTaskResponse
	(*common.DeletePaymentTaskResponse)(nil),             // 35: common.DeletePaymentTaskResponse
	(*User)(nil),                                         // 36: core.User
	(*ListUserResponse)(nil),                             // 37: core.ListUserResponse
	(*DeleteUserResponse)(nil),                           // 38: core.DeleteUserResponse
}
var file_core_core_proto_depIdxs = []int32{
	...
	8,  // 9: core.Core.CreateAccount:input_type -> core.CreateAccountRequest
	9,  // 10: core.Core.GetAccount:input_type -> core.GetAccountRequest
	10, // 11: core.Core.ListAccounts:input_type -> core.ListAccountRequest
	11, // 12: core.Core.ListUserAccounts:input_type -> core.ListUserAccountsRequest
	12, // 13: core.Core.CreateTransaction:input_type -> core.CreateTransactionRequest
	13, // 14: core.Core.GetTransaction:input_type -> core.GetTransactionRequest
	14, // 15: core.Core.ListTransactions:input_type -> core.ListTransactionRequest
	15, // 16: core.Core.ListUserTransactions:input_type -> core.ListUserTransactionsRequest
	16, // 17: core.Core.CreatePaymentTask:input_type -> common.CreatePaymentTaskRequest
	17, // 18: core.Core.CreateManyPaymentTask:input_type -> common.CreateManyPaymentTaskRequest
	18, // 19: core.Core.GetPaymentTask:input_type -> common.GetPaymentTaskRequest
	19, // 20: core.Core.ListPaymentTasks:input_type -> common.ListPaymentTaskRequest
	20, // 21: core.Core.UpdatePaymentTask:input_type -> common.UpdatePaymentTaskRequest
	21, // 22: core.Core.DeletePaymentTask:input_type -> common.DeletePaymentTaskRequest
	22, // 23: core.Core.GetUser:input_type -> core.GetUserRequest
	23, // 24: core.Core.ListUsers:input_type -> core.ListUserRequest
	24, // 25: core.Core.UpdateUser:input_type -> core.UpdateUserRequest
	25, // 26: core.Core.DeleteUser:input_type -> core.DeleteUserRequest
	26, // 27: core.Core.GetPaymentPlan:output_type -> common.PaymentPlanResponse
	27, // 28: core.Core.GetWaterfallOverview:output_type -> planning.WaterfallOverviewResponse
	28, // 29: core.Core.GetAmountPaidPercentage:output_type -> planning.GetAmountPaidPercentageResponse
	29, // 30: core.Core.GetPercentageCoveredByPlans:output_type -> planning.GetPercentageCoveredByPlansResponse
	5,  // 31: core.Core.CreateAccount:output_type -> core.Account
	5,  // 32: core.Core.GetAccount:output_type -> core.Account
	30, // 33: core.Core.ListAccounts:output_type -> core.ListAccountResponse
	30, // 34: core.Core.ListUserAccounts:output_type -> core.ListAccountResponse
	6,  // 35: core.Core.CreateTransaction:output_type -> core.Transaction
	6,  // 36: core.Core.GetTransaction:output_type -> core.Transaction
	31, // 37: core.Core.ListTransactions:output_type -> core.ListTransactionResponse
	31, // 38: core.Core.ListUserTransactions:output_type -> core.ListTransactionResponse
	32, // 39: core.Core.CreatePaymentTask:output_type -> common.PaymentTask
	33, // 40: core.Core.CreateManyPaymentTask:output_type -> common.CreateManyPaymentTaskResponse
	32, // 41: core.Core.GetPaymentTask:output_type -> common.PaymentTask
	34, // 42: core.Core.ListPaymentTasks:output_type -> common.ListPaymentTaskResponse
	32, // 43: core.Core.UpdatePaymentTask:output_type -> common.PaymentTask
	35, // 44: core.Core.DeletePaymentTask:output_type -> common.DeletePaymentTaskResponse
	36, // 45: core.Core.GetUser:output_type -> core.User
	37, // 46: core.Core.ListUsers:output_type -> core.ListUserResponse
	36, // 47: core.Core.UpdateUser:output_type -> core.User
	38, // 48: core.Core.DeleteUser:output_type -> core.DeleteUserResponse
