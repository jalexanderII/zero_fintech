...
var file_common_payment_plan_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x6c,
	...
	0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74,
	...
	0x68, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x47, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62,
...
var file_common_payment_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_payment_plan_proto_goTypes = []interface{}{
	...
	(PaymentActionStatus)(0),      // 3: common.PaymentActionStatus
	(PaymentFrequency)(0),         // 4: common.PaymentFrequency
	(PlanType)(0),                 // 5: common.PlanType
	(PaymentStatus)(0),            // 6: common.PaymentStatus
}
var file_common_payment_plan_proto_depIdxs = []int32{
	2, // 0: common.PaymentAction.transaction_date:type_name -> google.protobuf.Timestamp
	3, // 1: common.PaymentAction.status:type_name -> common.PaymentActionStatus
	4, // 2: common.PaymentPlan.payment_freq:type_name -> common.PaymentFrequency
	5, // 3: common.PaymentPlan.plan_type:type_name -> common.PlanType
	2, // 4: common.PaymentPlan.end_date:type_name -> google.protobuf.Timestamp
	6, // 5: common.PaymentPlan.status:type_name -> common.PaymentStatus
