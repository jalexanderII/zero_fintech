...
class GetDebitAccountBalanceRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    USER_ID_FIELD_NUMBER: builtins.int
    user_id: typing.Text = ...
    def __init__(self,
...
global___GetDebitAccountBalanceRequest = GetDebitAccountBalanceRequest

class GetDebitAccountBalanceResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    AVAILABLE_BALANCE_FIELD_NUMBER: builtins.int
    CURRENT_BALANCE_FIELD_NUMBER: builtins.int
    available_balance: builtins.float = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["available_balance",b"available_balance","current_balance",b"current_balance"]) -> None: ...
global___GetDebitAccountBalanceResponse = GetDebitAccountBalanceResponse
...
class IsDebitAccountLinkedRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    USER_ID_FIELD_NUMBER: builtins.int
    user_id: typing.Text = ...
    def __init__(self,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["user_id",b"user_id"]) -> None: ...
global___IsDebitAccountLinkedRequest = IsDebitAccountLinkedRequest

class IsDebitAccountLinkedResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___IsDebitAccountLinkedResponse = IsDebitAccountLinkedResponse

class IsCreditAccountLinkedRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    USER_ID_FIELD_NUMBER: builtins.int
    user_id: typing.Text = ...
    def __init__(self,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["user_id",b"user_id"]) -> None: ...
global___IsCreditAccountLinkedRequest = IsCreditAccountLinkedRequest

class IsCreditAccountLinkedResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    STATUS_FIELD_NUMBER: builtins.int
    status: builtins.bool = ...
    def __init__(self,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["status",b"status"]) -> None: ...
global___IsCreditAccountLinkedResponse = IsCreditAccountLinkedResponse
