...
class User(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["email",b"email","id",b"id","password",b"password","phone_number",b"phone_number","username",b"username"]) -> None: ...
global___User = User
...
global___GetUserByEmailRequest = GetUserByEmailRequest
